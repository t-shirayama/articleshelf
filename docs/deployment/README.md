...
| 変数                | 例                                  | 説明                        |
| ------------------- | ----------------------------------- | --------------------------- |
| `VITE_API_BASE_URL` | `https://articleshelf.onrender.com` | Render 上の backend API URL |
...
```text
https://articleshelf.onrender.com
```
...
```bash
gh release create v0.4.2 --generate-notes --title "ArticleShelf v0.4.2"
```

下書きから整えたい場合:

```bash
gh release create v0.4.2 --draft --generate-notes --title "ArticleShelf v0.4.2"
```
