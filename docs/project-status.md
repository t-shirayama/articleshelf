...
- テスト戦略は `docs/testing.md` に UT / IT / E2E の目的、スコープ、ケース、CI/CD 方針を整理済みだが、正式な UT / IT / E2E 実装は未整備
- ユーザー登録・ログイン・JWT認証設計は `docs/specification/authentication.md` に整理済みだが、Spring Security、ユーザースコープ、認証 UI、DB migration は未実装
