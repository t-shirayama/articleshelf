...
- 記事一覧表示
- タイトル / URL / 概要 or メモ / タグ / 登録日 / 読了日 / ステータスの表示
- 検索キーワードによる絞り込み
- 未読 / 読了 / お気に入りの切り替え
- 追加日 / 更新日 / 読了日 / タイトル / おすすめ度での並び替え
- 上部フィルタモーダルからのタグ複数選択、おすすめ度複数選択、登録日範囲、読了日範囲による絞り込み
- 適用中フィルタ条件の一覧上部表示
...
- トップページ上での未読 / 読了の相互切り替え
- タグ管理画面
- タグ追加 / 削除 UI・UX の改善
  - 見た目で操作意図が分かる導線へ見直す
  - 追加と削除をより少ない迷いで行えるようにする
- カレンダー画面
  - 記事追加日を表示するモード
  - 読了日を表示するモード
...
- 上部フィルタモーダルの複数タグ / おすすめ度 / 日付範囲の絞り込みはフロントエンド内で適用しており、記事件数が増えたときの性能検証はこれからです
