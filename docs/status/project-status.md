...
- フロントエンドは会社プロジェクト向けサンプルとして使いやすいよう、`App.vue` の薄い shell 化、feature-oriented な記事管理構成、feature composable 分離、pure function 分離、API client / adapter 分離、CSS ファイル分割を進めました
