...
採用技術、推奨バージョン、開発環境、テストツールの詳細は [技術スタック](technology.md) に集約する。

## 詳細文書

- [技術スタック](technology.md): 採用技術、推奨バージョン、開発環境、テストツール
...
- [CI / CD](ci-cd.md): GitHub Actions の段階構成、品質ゲート、デプロイとの関係
