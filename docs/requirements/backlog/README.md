...
- `P1`: 重要。近いタイミングで着手したい影響度の大きい改善、後続作業の前提になる設計変更、重大化しやすい信頼性 / セキュリティ改善
- `P2`: 標準。保守性、品質、UX、性能、拡張性を明確に高めるが、直ちに障害や大きな手戻りにはつながらないもの
- `P3`: 後回し。ドキュメント整理、説明力向上、軽微な品質改善、余裕があるときに進めるもの
