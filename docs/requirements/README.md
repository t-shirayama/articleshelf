...
このファイルは要件ドキュメントの入口として保守し、具体的な機能要件、非機能要件、Backlog は `docs/requirements/` 配下の項目別ファイルに記載します。
対象ユーザー、主な課題、解決方針は [プロダクト](../product/README.md) を参照してください。
今後やるべきこと、残作業、構想段階のアイデア、TODO は [Backlog](backlog/README.md) に集約し、1ファイル1タスクで状態別フォルダに置きます。

## 目次

- [機能要件](functional/README.md)
  ...
  - [Chrome 拡張機能](functional/browser-extension.md): 現在ページを popup から直接保存するブラウザ拡張
...
- [非機能要件](non-functional/README.md)
...
- [Backlog](backlog/README.md): 今後のタスク、残作業、構想段階のアイデア、TODO
