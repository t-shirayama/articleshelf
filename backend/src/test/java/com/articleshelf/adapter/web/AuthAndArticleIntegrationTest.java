...
@TestPropertySource(properties = {
        "spring.datasource.url=jdbc:h2:mem:articleshelf-test;MODE=PostgreSQL;DATABASE_TO_LOWER=TRUE;DB_CLOSE_DELAY=-1",
        ...
        "articleshelf.auth.initial-user-enabled=true",
...
class AuthAndArticleIntegrationTest {
    ...
    private AuthSession register(String username) throws Exception {
        MvcResult result = mockMvc.perform(post("/api/auth/register")
                ...
                .andReturn();
        return new AuthSession(readAccessToken(result), result.getResponse().getCookie("ARTICLESHELF_REFRESH"));
    }
