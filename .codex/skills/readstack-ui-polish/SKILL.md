---
name: readstack-ui-polish
description: Apply ReadStack-specific UI design rules when changing Vue components, Vuetify usage, CSS, layout, visual states, forms, modals, article cards, detail screens, sidebar, search/sort controls, or any user-facing interaction. Use this before implementing UI or visual changes, and when reviewing whether a ReadStack screen feels aligned, stable, and understandable.
---

# ReadStack UI Polish

Use this skill to keep ReadStack UI changes intentional instead of one-off. Always read `docs/designs/README.md` before changing user-facing UI.
