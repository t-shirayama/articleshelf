...
description: Refresh screenshots under `docs/designs/screenshots/` from the current ReadStack implementation. Use when UI changes make design images stale, when `docs/designs/README.md` needs to match the live app, or when a user asks to replace mock images with current implementation screenshots.
---
