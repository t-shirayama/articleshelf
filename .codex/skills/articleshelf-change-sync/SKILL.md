...
description: Keep ArticleShelf implementation, documentation, and verification aligned when changing frontend, backend, API contracts, persistence, UI behavior, project setup, or operational rules. Use this for any code change that may require updates to docs/designs/README.md, docs/specs/README.md, docs/specs/*, docs/architecture/README.md, docs/architecture/*, docs/requirements/backlog/README.md, docs/requirements/backlog/*, README.md, or AGENTS.md.
---
