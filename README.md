...
モバイル表示は、狭い画面幅での崩れを抑えるレスポンシブ調整までは入っていますが、スマホ向けUIのフル対応は未完了です。スマホ対応の検討内容と残作業は [docs/designs/mobile-responsive.md](docs/designs/mobile-responsive.md) に整理しています。
